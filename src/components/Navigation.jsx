...
import { Heart, Target, Users, Lightbulb, Laptop as NotebookPen, Trophy, BarChart3, Sparkles, Bot, MessageSquareHeart } from 'lucide-react';
...
export const Navigation = () => {
  ...
  const navItems = [
    ...
    { path: '/couples', label: 'Couples', icon: MessageSquareHeart },
